 ...
 *
 */
(function(n){"use strict";function r(t,i){return function(){i.apply(t,n.makeArray(arguments))}}function i(t,i){var e,u,f,o,s;for(e in t)if(t.hasOwnProperty(e)){if(u=t[e],!u.hubName)continue;s=i?u.on:u.off;for(f in u.client)if(u.client.hasOwnProperty(f)){if(o=u.client[f],!n.isFunction(o))continue;s.call(u,f,r(u,o))}}}if(typeof n.signalR!="function")throw new Error("SignalR: SignalR is not loaded. Please ensure jquery.signalR-x.js is referenced before ~/signalr/js.");var t=n.signalR;n.hubConnection.prototype.createHubProxies=function(){var t={};return this.starting(function(){i(t,!0);this._registerSubscribedHubs()}).disconnected(function(){i(t,!1)}),t.getIpHub=this.createHubProxy("getIpHub"),t.getIpHub.client={},t.getIpHub.server={retrieveIp:function(){return t.getIpHub.invoke.apply(t.getIpHub,n.merge(["RetrieveIp"],n.makeArray(arguments)))},updateIp:function(){return t.getIpHub.invoke.apply(t.getIpHub,n.merge(["UpdateIp"],n.makeArray(arguments)))}},t};t.hub=n.hubConnection("/signalr",{useDefaultPath:!1});n.extend(t,t.hub.createHubProxies())})(window.jQuery,window);$(function(){console.log("ready");var n=$.connection.getIpHub;n.client.retrieveIp=function(){console.log("retrieveIp called")};n.client.updateIp=function(n){$("#ip").text(n)};$.connection.hub.start().done(function(){console.log("Now connected, connection ID="+$.connection.hub.id);$("#btnIp").click(function(){var t=$("#textKeyForIp").val();return console.log("key: "+t),n.server.retrieveIp(t),!1})}).fail(function(){console.log("Could not connect")})});
/*
