...
///#source 1 1 /Scripts/jquery.signalR-2.0.3.js
...
(function ($, window, undefined) {
    ...
    $.hubConnection.prototype.createHubProxies = function () {
        ...
        proxies.getIpHub.server = {
            ...
            updateIp: function () {
                return proxies.getIpHub.invoke.apply(proxies.getIpHub, $.merge(["UpdateIp"], $.makeArray(arguments)));
             }
        };
...
///#source 1 1 /Scripts/appLogic.js
$(function () {
  console.log("ready");
